...
namespace ImGui
{
    ...
    IMGUI_API bool          DragFloat(const char* label, float* v, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* format = "%.3f", ImGuiSliderFlags flags = 0, ImDrawFlags draw_flags = 0);     // If v_min >= v_max we have no bound
    ...
    IMGUI_API bool          DragScalar(const char* label, ImGuiDataType data_type, void* p_data, float v_speed = 1.0f, const void* p_min = NULL, const void* p_max = NULL, const char* format = NULL, ImGuiSliderFlags flags = 0, ImDrawFlags draw_flags = 0);
...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_NoDockingTabIndicator  = 1 << 20,  // Don't show the triangle indicator for docked windows without tabbar
